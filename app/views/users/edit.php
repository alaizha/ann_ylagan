                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="birth_date" name="birth_date" 
                                       value="<?php echo isset($user['birth_date']) ? htmlspecialchars($user['birth_date']) : ''; ?>">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="province" name="province" 
                                       value="<?php echo isset($user['province']) ? htmlspecialchars($user['province']) : ''; ?>">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <input type="checkbox" id="is_active" name="is_active" value="1" 
                                   <?php echo (isset($user['is_active']) && $user['is_active']) ? 'checked' : ''; ?> style="width: auto;">
